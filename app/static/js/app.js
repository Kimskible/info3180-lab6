  ...
  <div class= "news">
    ...
    <div class="form-inline d-flex justify-content-center">
      <div class="form-group mx-sm-3 mb-2">
        ...
        <button class="btn btn-primary mb-2" @click="searchDesc">Search</button>
   </div>
  </div>
 <div class="row">
      <div class="col-md-4 mb-5" v-for="article in articles"> 
        <div class="card  h-100">
          <img class="card-img-top img-fluid images_" v-bind:src= article.urlToImage alt="Card image cap">
          <div class="card-body">
